...
namespace Photosnap_Mongodb.Service.UserService
{
    public interface IUserService
    {
        ...
        public Task<bool> IsUserFollowed(string loggedUserUsername, string username);
        ...
        public Task AddCategoryOfInterest(string userUsername, List<string> categoryNames);
        ...
        public Task<List<PhotoDTO>> GetUserLikedPhotos(string username, int numberOfPhotosToGet);
        ...
        public Task<int> GetTotalNumberOfUserLikedPhotos(string username);
